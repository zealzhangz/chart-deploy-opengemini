...
sed -i "s/meta_addr_1/meta1-0.meta1.$NAMESPACE.svc.cluster.local/g" $config
sed -i "s/meta_addr_2/meta2-0.meta2.$NAMESPACE.svc.cluster.local/g" $config
sed -i "s/meta_addr_3/meta3-0.meta3.$NAMESPACE.svc.cluster.local/g" $config
